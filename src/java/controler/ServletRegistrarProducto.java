...
public class ServletRegistrarProducto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        throws ServletException, IOException {
            ...
            BeanProductos beanProducto = new BeanProductos(request.getParameter("codigo"), request.getParameter("nombre"), request.getParameter("precio"),"0",(String)request.getSession().getAttribute("user"));
            InsertarProducto insertarProducto = new InsertarProducto(beanProducto);
            String res=insertarProducto.insertarProducto();
            if(res.equals("1")){
