 ...
 * @author prueba
 */
@WebServlet(name = "PaginarLeche", urlPatterns = {"/PaginarLeche"})
public class PaginarLeche extends HttpServlet {
 ...
 protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        BuscarLeche buscarTodos = new BuscarLeche(Integer.parseInt(request.getParameter("pagina"))*5);
