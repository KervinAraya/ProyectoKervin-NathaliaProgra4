 ...
 * @author kervin
 */
@WebServlet(name = "ServletBuscarUsuarioEliminar", urlPatterns = {"/ServletBuscarUsuarioEliminar"})
public class ServletBuscarUsuarioEliminar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(respuesta.equals("1")){
            request.getSession().setAttribute("cedulaUsuarioElimiar", buscarUsuario.getBenUsuario().getCedula());
