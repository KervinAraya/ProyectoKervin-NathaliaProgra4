...
public class ServletActualizarUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        BeanUsuario beanUsuario = new BeanUsuario(request.getParameter("nombre"), request.getParameter("apellido1"), request.getParameter("apellido2"), request.getParameter("cedula"), request.getParameter("telefono"), request.getParameter("correo"), request.getParameter("direccion"), "", request.getParameter("contrasena"), request.getParameter("usuario"), "");
        ModificarUsuario modificarUsuario = new ModificarUsuario(beanUsuario);
        String respuesta = modificarUsuario.updateUsuario();
        if(respuesta.equals("1")){
            request.getRequestDispatcher("modificarUsuario").forward(request, response);
        }else{
