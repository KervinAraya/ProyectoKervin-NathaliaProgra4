...
import Datos.ModificarProducto;
...
public class ServletActualizarProducto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
                ...
                BeanProductos beanProducto = new BeanProductos(request.getParameter("codigo"),request.getParameter("nombre"), request.getParameter("precio"), request.getParameter("cantidad"),request.getParameter("user"));
