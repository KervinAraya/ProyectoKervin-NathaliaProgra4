...
<head>
  ...
  <main>
    <div class="col ">
     <h1 class="well">MODIFICAR SOCIO </h1>
      <div class="row">
        <form action="ServletBuscarSocioModificar" method="POST">
 ...
 <div class="container">
      ...
      <div class="col-md-5  toppad  pull-right col-md-offset-3 ">
       ...
       <br>
        ...
        <form action="ServletActualizarSocio" method="POST">       
   
          <div class="panel panel-info">
            <div class="panel-heading" id="barra">
                <input type="text" id="nom" class="panel-title" name="nombreCompleto" value="<jsp:getProperty name="beanSocio" property="nombre"/> <jsp:getProperty name="beanSocio" property="apellido1"/> <jsp:getProperty name="beanSocio" property="apellido2"/>" readonly="readonly"  style="background-color: #DBE6B1">
            </div>
                ...
                <div class=" col-md-9 col-lg-9 "> 
                  <table class="table table-user-information">
                     <tbody>
                      ...
                      <tr>
                        <td>Cedula</td>
                        <td><input type="text" name="cedula" value="<jsp:getProperty name="beanSocio" property="cedula"/> " id="cedula" readonly="readonly" > </td>
                      </tr>
                      <tr>
                        <td>Nombre</td>
                        <td><input type="text" name="nombre" value="<jsp:getProperty name="beanSocio" property="nombre"/> " id="cedula" > </td>
                      </tr>
                      <tr>
                        <td>Primer Apellido</td>
                        <td><input type="text" name="apellido1" value="<jsp:getProperty name="beanSocio" property="apellido1"/> " id="cedula" > </td>
                      </tr>
                      <tr>
                        <td>Segundo Apellido</td>
                        <td><input type="text" name="apellido2" value="<jsp:getProperty name="beanSocio" property="apellido2"/> " id="cedula" > </td>
                      </tr>
                      <tr>
                        <td>Dirección</td>
                        <td><input type="text" name="direccion"  value="<jsp:getProperty name="beanSocio" property="direccion"/> " id="direccion"></td>
                      </tr>
                      <tr>
                        <td>Telefono</td>
                        <td><input type="text" name="telefono" onKeyPress="return fono(event)" value="<jsp:getProperty name="beanSocio" property="telefono"/> " id="telefono"></td>
                      </tr>
                        <tr>
                          <tr>
                            <td>Correo electrónico</td>
                            <td><input type="text" name="correo" value="<jsp:getProperty name="beanSocio" property="correo"/> " id="correo"></td>
                          </tr>
                          </tr>
