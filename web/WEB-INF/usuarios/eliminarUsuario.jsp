...
<head>
    ...
    <script type="text/javascript">
 	...
 	<main>
      <h1 class="well">ELIMINAR EMPLEADO</h1>
		<div class="col ">
           
		  <div class="row">
                      <form action="ServletBuscarUsuarioEliminar" method="POST">
		        ...
		        <div class="table-responsive">
	              ...
	              <table id="mytable" class="table table-bordred table-striped">
                     ...
                     <tbody id="filas">
                         ...
                         <tr>
                             <td><jsp:getProperty name="beanUsuario" property="cedula"/></td>    
                             <td><jsp:getProperty name="beanUsuario" property="nombre"/> <jsp:getProperty name="beanUsuario" property="apellido1"/> <jsp:getProperty name="beanUsuario" property="apellido2"/></td>   
                             <td><jsp:getProperty name="beanUsuario" property="correo"/></td>   
                             <td><jsp:getProperty name="beanUsuario" property="direccion"/></td>   
                             <td><jsp:getProperty name="beanUsuario" property="telefono"/></td>   
                         </tr>
                         ...
                         <form action="ServletElimiarUsuario" method="POST">
